<template lang="">
    <div class='mt-5'>
        ...
        <router-link :to="{ name: 'code.js.index' }" > <img class='icon_select active' src="@/assets/about/free-icon-js-5968292.png" alt=""></router-link> 
       <router-link :to="{ name: 'code.php.index' }" > <img class='icon_select' src="@/assets/about/free-icon-php-5968332.png" alt=""></router-link> 
